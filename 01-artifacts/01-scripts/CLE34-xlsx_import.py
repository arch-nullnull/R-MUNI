#!/usr/bin/env python3
# CLE34-xlsx_import.py
#
# Zweck:
# - Ordnerinhalt löschen (Ordner selbst bleibt erhalten)
# - Ziele:
#   01-artifacts\03-XLSX\04-import
#
# Ablageort  : <rootfolder>\01-artifacts\01-scripts\CLE34-xlsx_import.py
...
SCRIPT_KUERZEL = "CLE34"
LOG_FILENAME   = "CLE34-xlsx_import.log"

# Ziel-Ordner relativ zu <artifacts>
ZIEL_LISTE = [
    os.path.join('03-XLSX', '04-import'),
]
