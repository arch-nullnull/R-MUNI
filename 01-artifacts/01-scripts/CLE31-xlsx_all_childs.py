#!/usr/bin/env python3
# CLE31-xlsx_all_childs.py
#
# Zweck:
# - Ordnerinhalt löschen (Ordner selbst bleibt erhalten)
# - Ziele:
#   01-artifacts\03-XLSX\03-child\00-archimatechild
#   01-artifacts\03-XLSX\03-child\01-bpmnchild
#
# Ablageort  : <rootfolder>\01-artifacts\01-scripts\CLE31-xlsx_all_childs.py
...
SCRIPT_KUERZEL = "CLE31"
LOG_FILENAME   = "CLE31-xlsx_all_childs.log"

# Ziel-Ordner relativ zu <artifacts>
ZIEL_LISTE = [
    os.path.join('03-XLSX', '03-child', '00-archimatechild'),
    os.path.join('03-XLSX', '03-child', '01-bpmnchild'),
]
...
def main() -> None:
    ...
    for relativ in ZIEL_LISTE:
        ziel = os.path.join(artifacts, relativ)
