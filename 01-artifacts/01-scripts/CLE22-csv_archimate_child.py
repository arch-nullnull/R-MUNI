...
#
# Ablageort  : <rootfolder>\01-artifacts\01-scripts\CLE22-csv_archimate_child.py
...
SCRIPT_KUERZEL = "CLE22"
LOG_FILENAME   = "CLE22-csv_archimate_child.log"
