#!/usr/bin/env python3
# CLE11-xml_all_childs.py
#
# Zweck:
# - Ordnerinhalt löschen (Ordner selbst bleibt erhalten)
# - Ziele:
#   01-artifacts\00-xml\03-child\00-archimatechild
#   01-artifacts\00-xml\03-child\01-bpmnchild
#
# Ablageort  : <rootfolder>\01-artifacts\01-scripts\CLE11-xml_all_childs.py
...
SCRIPT_KUERZEL = "CLE11"
LOG_FILENAME   = "CLE11-xml_all_childs.log"

# Ziel-Ordner relativ zu <artifacts>
ZIEL_LISTE = [
    os.path.join('00-xml', '03-child', '00-archimatechild'),
    os.path.join('00-xml', '03-child', '01-bpmnchild'),
]
