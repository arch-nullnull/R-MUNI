#!/usr/bin/env python3
# CLE21-csv_all_childs.py
#
# Zweck:
# - Ordnerinhalt löschen (Ordner selbst bleibt erhalten)
# - Ziele:
#   01-artifacts\02-csv\03-child\00-archimatechild
#   01-artifacts\02-csv\03-child\01-bpmnchild
#
# Ablageort  : <rootfolder>\01-artifacts\01-scripts\CLE21-csv_all_childs.py
...
SCRIPT_KUERZEL = "CLE21"
LOG_FILENAME   = "CLE21-csv_all_childs.log"

# Ziel-Ordner relativ zu <artifacts>
ZIEL_LISTE = [
    os.path.join('02-csv', '03-child', '00-archimatechild'),
    os.path.join('02-csv', '03-child', '01-bpmnchild'),
]
