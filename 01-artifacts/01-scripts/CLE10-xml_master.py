...
# - Ziel: \01-artifacts\00-xml\00-master
#
# Ablageort  : <rootfolder>\01-artifacts\01-scripts\CLE10-xml_master.py
...
SCRIPT_KUERZEL = "CLE10"
LOG_FILENAME   = "CLE10-xml_master.log"

# Ziel-Ordner relativ zu <artifacts>
ZIEL_RELATIV = os.path.join("00-xml", "00-master")
...
def main() -> None:
    ...
    # Ziel-Ordner aufbauen
    ziel = os.path.join(artifacts, ZIEL_RELATIV)
