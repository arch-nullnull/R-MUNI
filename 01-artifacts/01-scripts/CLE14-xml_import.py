...
# - Ziele:
#   01-artifacts\00-xml\04-import
#
# Ablageort  : <rootfolder>\01-artifacts\01-scripts\CLE14-xml_import.py
...
SCRIPT_KUERZEL = "CLE14"
LOG_FILENAME   = "CLE14-xml_import.log"

# Ziel-Ordner relativ zu <artifacts>
ZIEL_LISTE = [
    os.path.join('00-xml', '04-import'),
]
