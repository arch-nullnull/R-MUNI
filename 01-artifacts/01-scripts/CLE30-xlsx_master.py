...
#
# Ablageort  : <rootfolder>\01-artifacts\01-scripts\CLE30-xlsx_master.py
...
SCRIPT_KUERZEL = "CLE30"
LOG_FILENAME   = "CLE30-xlsx_master.log"

# Ziel-Ordner relativ zu <artifacts>
ZIEL_LISTE = [
    os.path.join('03-XLSX', '00-master'),
]
