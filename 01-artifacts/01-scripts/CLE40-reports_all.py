#!/usr/bin/env python3
# CLE40-reports_all.py
#
# Zweck:
# - Ordnerinhalt löschen (Ordner selbst bleibt erhalten)
# - Ziele:
#   01-artifacts\05-reports\00-archimate
#   01-artifacts\05-reports\01-bpmn
#   01-artifacts\05-reports\99-html
#
# Ablageort  : <rootfolder>\01-artifacts\01-scripts\CLE40-reports_all.py
...
SCRIPT_KUERZEL = "CLE40"
LOG_FILENAME   = "CLE40-reports_all.log"

# Ziel-Ordner relativ zu <artifacts>
ZIEL_LISTE = [
    os.path.join('05-reports', '00-archimate'),
    os.path.join('05-reports', '01-bpmn'),
    os.path.join('05-reports', '99-html'),
]
