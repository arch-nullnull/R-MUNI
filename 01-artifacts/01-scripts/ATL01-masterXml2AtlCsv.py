...
#     <rootfolder>/02-stages/00-archimatearchive/atl_*.csv
# - Log:
#     <rootfolder>/02-stages/99-logs/ATL01-masterXml2AtlCsv.log
#
...
MASTER_XML_REL = os.path.join("01-artifacts", "00-xml", "00-master", "master.xml")
OUT_DIR_REL    = os.path.join("02-stages", "00-archimatearchive")
RUN_SCOPE_REL  = os.path.join("02-stages", "run-scope.txt")
...
def main() -> None:
    ...
    print(
        ...
        f"02-stages/00-archimatearchive/"
    )
