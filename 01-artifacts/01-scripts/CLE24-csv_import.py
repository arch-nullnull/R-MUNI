...
# - Ziele:
#   01-artifacts\02-csv\04-import
#
# Ablageort  : <rootfolder>\01-artifacts\01-scripts\CLE24-csv_import.py
...
SCRIPT_KUERZEL = "CLE24"
LOG_FILENAME   = "CLE24-csv_import.log"

# Ziel-Ordner relativ zu <artifacts>
ZIEL_LISTE = [
    os.path.join('02-csv', '04-import'),
]
