...
# Root-Auflösung über root.cfg — Script kann von überall aufgerufen werden
ROOT = Path(__file__).parent / "root.cfg"
if not ROOT.exists():
    raise FileNotFoundError(f"root.cfg nicht gefunden in: {ROOT.parent}")

BASE = ROOT.parent  # Projektverzeichnis = Ordner wo root.cfg liegt

INPUT_FILE    = BASE / "structure.txt"
OUT_ELEMENTS  = BASE / "01-artifacts" / "02-csv" / "04-import" / "elements.csv"
OUT_RELATIONS = BASE / "01-artifacts" / "02-csv" / "04-import" / "relations.csv"
