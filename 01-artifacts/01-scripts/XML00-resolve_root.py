...
#     <stages>\99-logs\XML00-root.resolved.txt
# - Log schreiben nach:
#     <stages>\99-logs\XML00-root.log
#
# Regeln:
...
SCRIPT_KUERZEL = "XML00"
LOG_FILENAME   = "XML00-root.log"
RESOLVED_FILE  = "XML00-root.resolved.txt"
...
def write_root_resolved(logs_dir: str, root_path: str, log_path: str | None) -> str:
    """
    Schreibt XML00-root.resolved.txt — wird von nachfolgenden
    XML-Scripts als schneller Root-Anker gelesen.
    """
