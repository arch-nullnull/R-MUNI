...
#
# Ablageort  : <rootfolder>\01-artifacts\01-scripts\CLE12-xml_archimate_child.py
...
SCRIPT_KUERZEL = "CLE12"
LOG_FILENAME   = "CLE12-xml_archimate_child.log"
