...
#
# Ablageort  : <rootfolder>\01-artifacts\01-scripts\CLE32-xlsx_archimate_child.py
...
SCRIPT_KUERZEL = "CLE32"
LOG_FILENAME   = "CLE32-xlsx_archimate_child.log"
