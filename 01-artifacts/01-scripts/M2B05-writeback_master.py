...
#
# Inputs:
#   <root>/00-model/01-bpmn/00-bpmnactive/*.bpmn
#   <root>/01-artifacts/00-xml/00-master/master.xml
#
# Output:
#   <root>/01-artifacts/00-xml/00-master/master.xml  (in-place update)
#
# Logs:
#   <root>/02-stages/99-logs/M2B05-writeback.log
...
ACTIVE_BPMN_DIR = ROOT_DIR / "00-model" / "01-bpmn" / "00-bpmnactive"
