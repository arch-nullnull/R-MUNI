...
#
# Ablageort  : <rootfolder>\01-artifacts\01-scripts\CLE35-xlsx_export.py
...
SCRIPT_KUERZEL = "CLE35"
LOG_FILENAME   = "CLE35-xlsx_export.log"

# Ziel-Ordner relativ zu <artifacts>
ZIEL_LISTE = [
    os.path.join('03-XLSX', '99-exports'),
]
