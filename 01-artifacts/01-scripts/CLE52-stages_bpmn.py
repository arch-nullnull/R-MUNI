...
#
# Ablageort  : <rootfolder>\01-artifacts\01-scripts\CLE52-stages_bpmn.py
...
SCRIPT_KUERZEL = "CLE52"
LOG_FILENAME   = "CLE52-stages_bpmn.log"

# Ziel-Ordner relativ zu <stages>
ZIEL_LISTE = [
    os.path.join('01-bpmnarchive'),
]
