...
File locations (relative to BLUEPRINT_ROOT):
  master.xml        01-artifacts\\00-xml\\00-master\\master.xml
  bpmn mapping      01-artifacts\\00-xml\\01-mapping\\bpmnmastercsvsync.txt
  csv output        01-artifacts\\02-csv\\00-master
  log               02-stages\\99-logs\\CSV09-masterXml2Csv.log
  run-scope         02-stages\\run-scope.txt
...
MASTER_XML_REL   = r"01-artifacts\00-xml\00-master\master.xml"
RUN_SCOPE_REL    = r"02-stages\run-scope.txt"
CSV_OUT_REL      = r"01-artifacts\02-csv\00-master"
LOG_REL          = r"02-stages\99-logs\CSV09-masterXml2Csv.log"
BPMN_MAPPING_REL = r"01-artifacts\00-xml\01-mapping\bpmnmastercsvsync.txt"
...
def resolve_root() -> Path:
    ...
    raise FileNotFoundError(
        "root.cfg not found or BLUEPRINT_ROOT not set. "
