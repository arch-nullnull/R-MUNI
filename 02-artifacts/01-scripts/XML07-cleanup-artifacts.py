...
def main():
    ...
    MASTER_DIR = os.path.join(ROOT, "02-artifacts", "00-xml", "00-master")
    ARCHI_ARCHIVE_DIR = os.path.join(ROOT, "03-stages", "00-archimatearchive")
    BPMN_ARCHIVE_DIR = os.path.join(ROOT, "03-stages", "01-bpmnarchive")
