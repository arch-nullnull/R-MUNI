...
#   <root>/02-artifacts/00-xml/01-mapping/mapping.txt
#
# Output:
#   <root>/02-artifacts/00-xml/00-master/master.generated.xml
#
# Logs:
#   <root>/03-stages/99-logs/XML04-merge.log
...
def main():
    ...
    log_path = os.path.join(root, "03-stages", "99-logs", "XML04-merge.log")
    ...
    for src, sub in [("archi", "00-archimatearchive"), ("bpmn", "01-bpmnarchive")]:
        index_path = os.path.join(root, "03-stages", sub, "XML03-index.xml")
